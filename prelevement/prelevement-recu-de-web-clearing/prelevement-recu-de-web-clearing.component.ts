...
@Component({
  selector: 'app-prelevement-recu-de-web-clearing',
  standalone: true,
  imports: [CommonModule, SharedModule],
  templateUrl: './prelevement-recu-de-web-clearing.component.html',
  styleUrls: ['./prelevement-recu-de-web-clearing.component.scss']
})
export default class PrelevementRecuDeWebClearingComponent implements OnInit {
