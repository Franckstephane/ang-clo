...
@Component({
  selector: 'app-prelevement-envoyees-areis',
  standalone: true,
  imports: [CommonModule, SharedModule],
  templateUrl: './prelevement-envoyees-areis.component.html',
  styleUrls: ['./prelevement-envoyees-areis.component.scss']
})
export default class PrelevementEnvoyeesAReisComponent implements OnInit {
