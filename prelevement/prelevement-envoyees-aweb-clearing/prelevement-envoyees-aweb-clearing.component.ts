...
@Component({
  selector: 'app-prelevement-envoyees-aweb-clearing',
  standalone: true,
  imports: [CommonModule, SharedModule],
  templateUrl: './prelevement-envoyees-aweb-clearing.component.html',
  styleUrls: ['./prelevement-envoyees-aweb-clearing.component.scss']
})
export default class PrelevementEnvoyeesAWebClearingComponent implements OnInit {
