...
@Component({
  selector: 'app-prelevement-bloquees-apres-retour-reis',
  standalone: true,
  imports: [CommonModule, SharedModule],
  templateUrl: './prelevement-bloquees-apres-retour-reis.component.html',
  styleUrls: ['./prelevement-bloquees-apres-retour-reis.component.scss']
})
export default class PrelevementBloqueesApresRetourReisComponent implements OnInit {
