...
@Component({
  selector: 'app-cheque-traitees-avec-erreur-apres-retour-reis',
  standalone: true,
  imports: [CommonModule, SharedModule],
  templateUrl: './cheque-traitees-avec-erreur-apres-retour-reis.component.html',
  styleUrls: ['./cheque-traitees-avec-erreur-apres-retour-reis.component.scss']
})
export default class ChequeTraiteesAvecErreurApresRetourREISComponent implements OnInit {
