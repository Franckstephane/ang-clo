...
@Component({
  selector: 'app-cheque-recu-de-reiz',
  standalone: true,
  imports: [CommonModule, SharedModule],
  templateUrl: './cheque-recu-de-reiz.component.html',
  styleUrls: ['./cheque-recu-de-reiz.component.scss']
})
export default class ChequeRecuDeReizComponent implements OnInit {
