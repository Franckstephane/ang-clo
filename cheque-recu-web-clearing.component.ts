...
@Component({
  selector: 'app-cheque-recu-web-clearing',
  standalone: true,
  imports: [CommonModule, SharedModule],
  templateUrl: './cheque-recu-web-clearing.component.html',
  styleUrls: ['./cheque-recu-web-clearing.component.scss']
})
export default class ChequeRecuWebClearingComponent implements OnInit {
